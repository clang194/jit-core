...
const byteReverseHalf = arm_scalar.byteReverseHalf;
const byteReverseHalfwords = arm_scalar.byteReverseHalfwords;
const byteReverseWord = arm_scalar.byteReverseWord;
const lowMask32 = arm_scalar.lowMask32;
const reverseBitsWord = arm_scalar.reverseBitsWord;
