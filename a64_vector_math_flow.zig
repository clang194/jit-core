...
pub const Core64Methods = struct {
    ...
    pub fn runVectorShiftImmediate(self: *Core64, word: u32) Core64Error!bool {
        ...
        if (masked != 0x0f000400 and masked != 0x0f001400 and masked != 0x0f005400 and masked != 0x0f008400 and masked != 0x0f008c00 and masked != 0x0f00a400 and masked != 0x2f000400 and masked != 0x2f001400 and masked != 0x2f002400 and masked != 0x2f00a400) {
            return false;
        }
        ...
        const rounded_right = masked == 0x2f002400;
    ...
    pub fn runVectorWideningArithmetic(self: *Core64, word: u32) Core64Error!bool {
        ...
        if (!signed and masked != 0x2e201000 and masked != 0x2e203000) {
            return false;
        }
