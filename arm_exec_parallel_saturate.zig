...
const clampSignedByte = arm_scalar.clampSignedByte;
const clampSignedHalfWord = arm_scalar.clampSignedHalfWord;
const clampUnsignedHalfWord = arm_scalar.clampUnsignedHalfWord;
