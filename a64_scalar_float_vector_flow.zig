...
const a64_float = @import("a64_float_arithmetic.zig");
const floatMulExtended = a64_float.floatMulExtended;
const floatSub = a64_float.floatSub;
const a64_nan = @import("a64_float_nan.zig");
const isNan32 = a64_nan.isNan32;
const isNan64 = a64_nan.isNan64;
const a64_float_ops = @import("a64_vector_float.zig");
const compareFloatZeroScalar = a64_float_ops.compareFloatZeroScalar;
const equalHalfFloat = a64_float_ops.equalHalfFloat;
const a64_float_convert = @import("a64_float_control.zig");
const floatInput32 = a64_float_convert.floatInput32;
const float64To32Odd = a64_float_convert.float64To32Odd;
const floatInput64 = a64_float_convert.floatInput64;
const signedDoublewordToFloat64 = a64_float_convert.signedDoublewordToFloat64;
const signedWordToFloat32 = a64_float_convert.signedWordToFloat32;
const unsignedDoublewordToFloat64 = a64_float_convert.unsignedDoublewordToFloat64;
const unsignedWordToFloat32 = a64_float_convert.unsignedWordToFloat32;
...
pub const Core64Methods = struct {
    ...
    pub fn runScalarReciprocalEstimate(self: *Core64, word: u32) Core64Error!bool {
        const half = (word & 0xfffffc00) == 0x5ef9d800;
        const masked = word & 0xffbffc00;
        if (!half and masked != 0x5e21d800 and masked != 0x5ea1d800) {
            return false;
        }
        ...
        var status = float_status.FloatStatus.init(self.state.floatStatus());
        const result = if (half) blk: {
            break :blk @as(u64, float_estimate.reciprocalEstimate16(@intCast(u16, source), control, &status) catch return error.MissingFallback);
        } else if (double) blk: {
