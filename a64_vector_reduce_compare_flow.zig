...
const integerMaximum = a64_flags.integerMaximum;
const integerMinimum = a64_flags.integerMinimum;
...
const pairwiseAddWideVector = a64_vector_access.pairwiseAddWideVector;
...
const equalVectorLanes = a64_vector_compare.equalVectorLanes;
const greaterSignedVectorLanes = a64_vector_compare.greaterSignedVectorLanes;
const greaterUnsignedVectorLanes = a64_vector_compare.greaterUnsignedVectorLanes;
const minMaxVectorLanes = a64_vector_compare.minMaxVectorLanes;
const pairVectorExtrema = a64_vector_compare.pairVectorExtrema;
const pairVectorHalves = a64_vector_compare.pairVectorHalves;
