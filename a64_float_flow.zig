...
pub const Core64Methods = struct {
    ...
    pub fn runFloatToInteger(self: *Core64, word: u32) Core64Error!bool {
        const masked = word & 0x7f3ffc00;
        if (masked != 0x1e200000 and masked != 0x1e210000 and masked != 0x1e240000 and masked != 0x1e250000 and masked != 0x1e280000 and masked != 0x1e290000 and masked != 0x1e380000 and masked != 0x1e390000) {
            return false;
        }
