...
const isLastFloatWord = arm_float_math.isLastFloatWord;
const nextFloatWordReg = arm_float_math.nextFloatWordReg;
...
const runFloatUnary = arm_float_arith_run.runFloatUnary;
