...
const arm_decode = @import("arm_exec_fetch_decode.zig");
const expandArmImmediate = arm_decode.expandArmImmediate;
const arm_float_math = @import("arm_exec_float_math.zig");
const mergeStatus = arm_float_math.mergeStatus;
const statusWriteField = arm_float_math.statusWriteField;
const statusWriteMask = arm_float_math.statusWriteMask;
...
const addSigned = arm_scalar.addSigned;
const countLeadingZeros32 = arm_scalar.countLeadingZeros32;
