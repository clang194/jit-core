...
const abs32 = text_common.abs32;
const formatThumbBitReg = text_common.formatThumbBitReg;
const formatThumbMultiple = text_common.formatThumbMultiple;
const formatThumbPop = text_common.formatThumbPop;
const formatThumbPush = text_common.formatThumbPush;
const formatThumbShiftImm = text_common.formatThumbShiftImm;
const formatThumbShiftReg = text_common.formatThumbShiftReg;
const formatThumbTransferImm = text_common.formatThumbTransferImm;
const formatThumbTransferReg = text_common.formatThumbTransferReg;
const formatThumbUnaryReg = text_common.formatThumbUnaryReg;
const signChar = text_common.signChar;
