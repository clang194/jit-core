...
const floatMax = a64_float_minmax.floatMax;
const floatMaxNumber = a64_float_minmax.floatMaxNumber;
const floatMin = a64_float_minmax.floatMin;
const floatMinNumber = a64_float_minmax.floatMinNumber;
...
const a64_vector_float = @import("a64_vector_float.zig");
const absoluteDifferenceFloatVector = a64_vector_float.absoluteDifferenceFloatVector;
const absoluteFloatVector = a64_vector_float.absoluteFloatVector;
const absoluteHalfFloatVector = a64_vector_float.absoluteHalfFloatVector;
const addFloatPairsVector = a64_vector_float.addFloatPairsVector;
const addFloatVector = a64_vector_float.addFloatVector;
const compareFloatZeroScalar = a64_vector_float.compareFloatZeroScalar;
const compareFloatZeroVector = a64_vector_float.compareFloatZeroVector;
const compareFloatVector = a64_vector_float.compareFloatVector;
const divideFloatVector = a64_vector_float.divideFloatVector;
const equalFloatVector = a64_vector_float.equalFloatVector;
const equalHalfFloatVector = a64_vector_float.equalHalfFloatVector;
const equalHalfFloatZeroVector = a64_vector_float.equalHalfFloatZeroVector;
const extremaFloatPairsVector = a64_vector_float.extremaFloatPairsVector;
const fixedFloatVector = a64_vector_float.fixedFloatVector;
const fixedHalfFloatVector = a64_vector_float.fixedHalfFloatVector;
const fusedMultiplyAddFloatVector = a64_vector_float.fusedMultiplyAddFloatVector;
const fusedMultiplyAddHalfFloatVector = a64_vector_float.fusedMultiplyAddHalfFloatVector;
const inverseRootEstimateFloatVector = a64_vector_float.inverseRootEstimateFloatVector;
const inverseRootEstimateUnsignedVector = a64_vector_float.inverseRootEstimateUnsignedVector;
const maximumFloatVector = a64_vector_float.maximumFloatVector;
const maximumNumberFloatVector = a64_vector_float.maximumNumberFloatVector;
const minimumFloatVector = a64_vector_float.minimumFloatVector;
const minimumNumberFloatVector = a64_vector_float.minimumNumberFloatVector;
const multiplyExtendedFloatVector = a64_vector_float.multiplyExtendedFloatVector;
const multiplyFloatVector = a64_vector_float.multiplyFloatVector;
const narrowDoubleFloatVectorOdd = a64_vector_float.narrowDoubleFloatVectorOdd;
const narrowFloatVector = a64_vector_float.narrowFloatVector;
const negateFloatVector = a64_vector_float.negateFloatVector;
const negateHalfFloatVector = a64_vector_float.negateHalfFloatVector;
const reciprocalEstimateFloatVector = a64_vector_float.reciprocalEstimateFloatVector;
const reciprocalEstimateHalfFloatVector = a64_vector_float.reciprocalEstimateHalfFloatVector;
const reciprocalEstimateUnsignedVector = a64_vector_float.reciprocalEstimateUnsignedVector;
const reciprocalStepFloatVector = a64_vector_float.reciprocalStepFloatVector;
const reciprocalStepHalfFloatVector = a64_vector_float.reciprocalStepHalfFloatVector;
const rootStepFloatVector = a64_vector_float.rootStepFloatVector;
const rootStepHalfFloatVector = a64_vector_float.rootStepHalfFloatVector;
const roundIntegralFloatVector = a64_vector_float.roundIntegralFloatVector;
const signedDoublewordsToFloatVector = a64_vector_float.signedDoublewordsToFloatVector;
const signedWordsToFloatVector = a64_vector_float.signedWordsToFloatVector;
const squareRootFloatVector = a64_vector_float.squareRootFloatVector;
const subtractFloatVector = a64_vector_float.subtractFloatVector;
const unsignedDoublewordsToFloatVector = a64_vector_float.unsignedDoublewordsToFloatVector;
const unsignedWordsToFloatVector = a64_vector_float.unsignedWordsToFloatVector;
const widenFloatVector = a64_vector_float.widenFloatVector;
