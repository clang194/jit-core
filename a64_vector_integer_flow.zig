...
const signedSaturatedAdd = a64_flags.signedSaturatedAdd;
const signedSaturatedDoublingMultiplyHigh = a64_flags.signedSaturatedDoublingMultiplyHigh;
const signedSaturatedSub = a64_flags.signedSaturatedSub;
const unsignedSaturatedAdd = a64_flags.unsignedSaturatedAdd;
const unsignedSaturatedSub = a64_flags.unsignedSaturatedSub;
...
const polynomialByteVector = a64_crypto.polynomialByteVector;
const polynomialWideByteVector = a64_crypto.polynomialWideByteVector;
const polynomialWideWordProduct = a64_crypto.polynomialWideWordProduct;
const a64_vector_integer = @import("a64_vector_integer.zig");
const SaturatingVectorResult = a64_vector_integer.SaturatingVectorResult;
const addVectorLanes = a64_vector_integer.addVectorLanes;
const differenceSignedVectorLanes = a64_vector_integer.differenceSignedVectorLanes;
const differenceUnsignedVectorLanes = a64_vector_integer.differenceUnsignedVectorLanes;
const halvingAddVectorLanes = a64_vector_integer.halvingAddVectorLanes;
const halvingSubtractVectorLanes = a64_vector_integer.halvingSubtractVectorLanes;
const multiplyVectorLanes = a64_vector_integer.multiplyVectorLanes;
const roundingHalvingAddVectorLanes = a64_vector_integer.roundingHalvingAddVectorLanes;
const saturatingVectorLanes = a64_vector_integer.saturatingVectorLanes;
const signedHalvingAddVectorLanes = a64_vector_integer.signedHalvingAddVectorLanes;
const signedHalvingSubtractVectorLanes = a64_vector_integer.signedHalvingSubtractVectorLanes;
const signedRoundingHalvingAddVectorLanes = a64_vector_integer.signedRoundingHalvingAddVectorLanes;
const signedSaturatingDoublingLongProductHalf = a64_vector_integer.signedSaturatingDoublingLongProductHalf;
const signedSaturatingDoublingMultiplyHighVectorLanes = a64_vector_integer.signedSaturatingDoublingMultiplyHighVectorLanes;
const signedSaturatingDoublingProductParts64 = a64_vector_integer.signedSaturatingDoublingProductParts64;
const signedSaturatingDoublingProductPartsVector = a64_vector_integer.signedSaturatingDoublingProductPartsVector;
const subtractVectorLanes = a64_vector_integer.subtractVectorLanes;
usingnamespace @import("a64_vector_float.zig");
usingnamespace @import("a64_vector_compare.zig");
const a64_vector_compare = @import("a64_vector_compare.zig");
const sharedBitVectorLanes = a64_vector_compare.sharedBitVectorLanes;
usingnamespace @import("a64_vector_shift.zig");
const a64_shift = @import("a64_vector_shift.zig");
const shiftRightVectorLanes = a64_shift.shiftRightVectorLanes;
const variableRoundedSignedShiftVectorLanes = a64_shift.variableRoundedSignedShiftVectorLanes;
const variableRoundedUnsignedShiftVectorLanes = a64_shift.variableRoundedUnsignedShiftVectorLanes;
const variableSignedSaturatingShiftLeftVectorLanes = a64_shift.variableSignedSaturatingShiftLeftVectorLanes;
const variableSignedShiftVectorLanes = a64_shift.variableSignedShiftVectorLanes;
const variableUnsignedSaturatingShiftLeftVectorLanes = a64_shift.variableUnsignedSaturatingShiftLeftVectorLanes;
const variableUnsignedShiftVectorLanes = a64_shift.variableUnsignedShiftVectorLanes;
...
pub const Core64Methods = struct {
    pub fn runScalarVectorArithmetic(self: *Core64, word: u32) Core64Error!bool {
        ...
        if (signed_saturating_shift or unsigned_saturating_shift) {
            const width = @as(u8, 8) << @intCast(u3, size);
            const mask = ones(width);
            const shifted = if (signed_saturating_shift)
                variableSignedSaturatingShiftLeftVectorLanes(left & mask, right & mask, width)
            else
                variableUnsignedSaturatingShiftLeftVectorLanes(left & mask, right & mask, width);
